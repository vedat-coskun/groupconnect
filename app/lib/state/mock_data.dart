...
class MockData {
  ...
  static TenantData _buildUniversity() {
    ...
    final invitations = <Invitation>[
      ...
      // NOT: Vedat'ın GÖNDERDİĞİ seed davetleri KALDIRILDI (2026-08-02) —
      // Vedat akademisyendir, matris herkesi doğrudan gördüğü için onay daveti
      // GÖNDEREMEZ; "Gönderdiğim"de davet görünmesi modelle çelişiyordu. Giden
      // davet akışı artık öğrenci kimliğiyle (Demo) canlı test edilir.
    ];
